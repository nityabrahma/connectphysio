...
export type TreatmentQuestionsFormValues = z.infer<typeof formSchema>

interface TreatmentQuestionsFormProps {
...
export function TreatmentQuestionsForm({ onSubmit, onDelete, formDef }: TreatmentQuestionsFormProps) {
    const { user: currentUser } = useAuth();
    const isEditing = !!formDef;
    
    const form = useForm<TreatmentQuestionsFormValues>({
    ...
    const handleFormSubmit = (values: TreatmentQuestionsFormValues) => {
