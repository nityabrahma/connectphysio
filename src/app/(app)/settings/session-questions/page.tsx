...
export default function SessionQuestionsPage() {
  ...
  const handleAddClick = () => {
    router.push('/settings/session-questions/new');
  };
  
  const handleEditClick = (q: Questionnaire) => {
    router.push(`/settings/session-questions/edit/${q.id}`);
  }
    ...
    <div className="flex flex-col gap-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Create and manage forms for specific sessions.</p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          <div>
            ...
            <CardDescription>These forms are used to gather session-specific information.</CardDescription>
          </div>
