...
export default function LandingPage() {
  ...
  const features = [
    {
      ...
      description:
        "Manage appointments with an intuitive calendar. View schedules by day, week, or month.",
    },
    {
      icon: <Users className="h-8 w-8 text-primary" />,
      title: "Patient Management",
      description:
        "Keep detailed patient records, track progress, and manage therapy packages all in one place.",
    },
    {
      icon: <FileText className="h-8 w-8 text-primary" />,
      title: "Session Tracking",
      description:
        "Log health notes, track payments, and manage check-ins for every session seamlessly.",
    },
    {
      icon: <BarChart className="h-8 w-8 text-primary" />,
      title: "Multi-Clinic Ready",
      description:
        "Scale your business with a system built to handle multiple clinic locations from a single admin account.",
    },
  ];
  ...
  const testimonials = [
    ...
    {
      quote:
        "The ability to manage multiple locations from one dashboard is a game-changer for our franchise. It's intuitive, powerful, and has saved us countless hours.",
      name: "John Maxwell",
    ...
    {
      quote:
        "As a receptionist, the check-in system and patient dashboard are fantastic. I can see the whole day at a glance and manage appointments with just a few clicks.",
      name: "Sarah Chen",
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Yes. The admin dashboard allows you to create, edit, and manage unique therapy packages tailored to your clinic's services, including setting the number of sessions, duration, and price.",
    },
    {
      question: "Is my patient data secure?",
      answer:
        "We take data security very seriously. All data is stored securely, and the application is built with role-based access control, meaning staff can only see the information relevant to their position.",
    },
    {
            ...
            >
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Focus on your patients, we'll handle the rest. Our powerful
                  features are designed to be intuitive and save you time.
                </p>
              </div>
            </motion.div>
            <motion.div
          ...
          <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
            ...
            >
              {testimonials.map((testimonial) => (
                <motion.div key={testimonial.name} variants={fadeInFromBottom}>
                  <Card>
